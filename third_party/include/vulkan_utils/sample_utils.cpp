...
namespace vk
{
  namespace su
  {
                                                               ...
                                                               void * /*pUserData*/)
    {
      ...
      std::cerr << vk::to_string(vk::DebugUtilsMessageSeverityFlagBitsEXT(messageSeverity)) << ": " << vk::to_string(vk::DebugUtilsMessageTypeFlagsEXT(messageTypes)) << ":\n";
      ...
      if (0 < pCallbackData->objectCount)
      {
        ...
        for (uint32_t i = 0; i < pCallbackData->objectCount; i++)
        {
          ...
          std::cerr << std::string("\t\t\t") << "objectType   = " << vk::to_string(vk::ObjectType(pCallbackData->pObjects[i].objectType)) << "\n";
